 ...
 */
public class SplitStrTrimFilterLen extends TestCase {

    private static final String STR1 = "Dies ist ein Satz mit mehreren worten und ein " +
            "gaaaaaaaaaanzz langes wort und noooooooooooch mal lange worte hats hier " +
            "zuletzt noch mal ein laaaaaaanges";
    private static final char SPLIT_CHAR = ' ';
    private static final long LESSER = 9;
    private static final long MORE = 3;

    @Override
    public String getCaseName() {
        return "Split string at space character, trim, filter words by length and uppercase";
    }
